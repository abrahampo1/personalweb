...
var letters = 'ぁ あ ぃ い ぅ ぇ お か が き ぎ く ぐ け げ こ  で と さ ぬ ば を フ ェ タ ム な ゝ ら ノ は';
...
ventanas = document.getElementsByClassName("drag");
header_ventanas = document.getElementsByClassName('bar-drag');

for (let index = 0; index < ventanas.length; index++) {
    dragElement(ventanas[index], header_ventanas[index]);
}
